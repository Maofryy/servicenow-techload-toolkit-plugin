...
description: >
  Use this skill when the user asks to "create a slide deck", "build a presentation",
  "make slides", "generate a deck", or any request for a magazine-quality HTML slide
  deck. Also trigger when the user invokes "html-slides-agent" directly.
---

Generate a stunning magazine-quality slide deck as a self-contained HTML page for the user's request.
